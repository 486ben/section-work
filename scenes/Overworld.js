    ...
    create() {
        ...
        this.physics.world.on('worldbounds', (body, blockedUp, blockedDown, blockedLeft, blockedRight) => {
            ...
            if(blockedDown){
                ...
                this.physics.world.setBounds(this.ROOMWIDTH-this.player.displayWidth/2, 256, 
            ...
            if (blockedLeft) {
                ...
                this.physics.world.setBounds(512, 0, 
                    0, this.ROOMHEIGHT+this.player.displayHeight/2);
            }
            if (blockedRight) {
                this.cameras.main.flash(250);
                this.cameras.main.shake(250);
